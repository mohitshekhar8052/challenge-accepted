      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-8 mb-16">
            <Image 
              src="/assets/character-celebrating.png"
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-center">
              <Image 
                src="/assets/characters-highfive.png"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="soft-card p-8 md:p-12 shadow-medium relative overflow-hidden">
            ...
            <Image 
              ...
              width={128}
              height={128}
              className="absolute -left-4 -bottom-4 object-contain opacity-80 animate-bounce-gentle hidden md:block"
            />
            <Image 
              src="/assets/character-celebrating.png"
              alt="Celebrating character" 
              width={128}
              height={128}
              className="absolute -right-4 -bottom-4 object-contain opacity-80 animate-bounce-gentle hidden md:block"
      ...
      >
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <Link href="/dashboard">
                <Button variant="default" size="sm" className="text-xs sm:text-sm">Dashboard</Button>
              </Link>
            ) : (
              <Link href="/auth">
